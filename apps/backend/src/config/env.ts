...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    googleAuthRedirectUri: process.env.GOOGLE_REDIRECT_URI ?? process.env.GOOGLE_AUTH_REDIRECT_URI ?? 'https://pookie-chat-0s89.onrender.com/api/auth/google/callback',
    smtpHost,
    smtpPort,
    smtpUser,
    smtpPass,
